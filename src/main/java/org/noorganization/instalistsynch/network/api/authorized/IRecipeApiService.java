...
public interface IRecipeApiService {
    ...
    Call<List<RecipeResponse>> getRecipes(@Path("id") int _id, @Query("changedSince") String _sinceTimeString);
    ...
    Call<RetrofitUUIDResponse> createRecipe(@Path("id") int _id, @Body Recipe _Recipe);
    ...
    Call<RecipeResponse> getRecipe(@Path("id") int _id, @Path("uuid") String _uuid);
    ...
    Call<RetrofitUUIDResponse> updateRecipe(@Path("id") int _id, @Path("uuid") String _uuid, @Body Recipe _Recipe);
    ...
    Call<RetrofitUUIDResponse> deleteRecipe(@Path("id") int _id, @Path("uuid") String _uuid);
